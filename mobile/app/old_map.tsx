...
export default function Map() {
  ...
  // Fetching nearby places based on current location and selected category
  const fetchPlaces = useCallback(async () => {
    try {
      ...
      console.log("Places API results:", results[0]); 
      ...
      console.log("Formatted Places:", formatted[0]);
      setPlaces(formatted);
    } catch (err: any) {
  ...
  return (
    <View className="flex-1">
      ...
      {/* No places */}
      {places.length === 0 && (
        <View className="absolute top-4 left-5 right-5 bg-white p-4 rounded-xl shadow-md">
